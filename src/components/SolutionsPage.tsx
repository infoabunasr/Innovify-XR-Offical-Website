...
interface SolutionsPageProps {
  ...
  onNavigateToIndustries?: (industryId?: string) => void;
}
            ...
            {INDUSTRIES.map((ind) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 pt-0 flex flex-col sm:flex-row items-center gap-2">
                    <button
                      onClick={() => {
                        if (onNavigateToIndustries) {
                          onNavigateToIndustries(ind.id);
                        } else {
                          onOpenIntake(`${ind.title} Industry`);
                        }
                      }}
                      className="w-full inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 py-2.5 px-3 rounded-xl transition-colors border border-blue-150"
                    >
                      <span>Explore {ind.title} Sector</span>
                      <ArrowRight className="w-3.5 h-3.5" />
                    </button>
                    <button
                      onClick={() => onOpenIntake(`${ind.title} Solution`)}
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-1 text-xs font-semibold text-slate-700 hover:text-blue-600 bg-slate-100 hover:bg-slate-200 py-2.5 px-3.5 rounded-xl transition-colors border border-slate-200 shrink-0"
                    >
