...
import { Mail, Linkedin, Instagram, Facebook, Youtube, Phone, MessageCircle, ArrowUpRight, Sparkles } from 'lucide-react';
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2">
              <a
                ...
                rel="noreferrer"
                aria-label="LinkedIn"
                className="p-2 rounded-lg bg-white border border-slate-200 text-slate-600 hover:text-blue-600 hover:border-blue-300 transition-colors"
              >
              ...
              <a
                ...
                className="p-2 rounded-lg bg-white border border-slate-200 text-slate-600 hover:text-pink-600 hover:border-pink-300 transition-colors"
              >
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="p-2 rounded-lg bg-white border border-slate-200 text-slate-600 hover:text-blue-700 hover:border-blue-400 transition-colors"
              >
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="YouTube"
                className="p-2 rounded-lg bg-white border border-slate-200 text-slate-600 hover:text-red-600 hover:border-red-300 transition-colors"
              >
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <a
                ...
                className="inline-flex items-center gap-2 text-slate-700 hover:text-blue-600 transition-colors p-2 rounded-lg bg-white border border-slate-200 w-full overflow-hidden"
              >
                <Mail className="w-3.5 h-3.5 text-blue-600 shrink-0" />
                <span className="truncate">contac@innovifyxr.com</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 text-slate-700 hover:text-emerald-600 transition-colors p-2 rounded-lg bg-white border border-slate-200 w-full overflow-hidden"
              >
                <Phone className="w-3.5 h-3.5 text-emerald-600 shrink-0" />
                <span className="truncate">+92 320 4513240</span>
              </a>

              <button
                onClick={onOpenIntake}
                className="w-full inline-flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold uppercase tracking-wider text-[11px] py-2.5 rounded-full transition-all shadow-2xs mt-1"
              >
