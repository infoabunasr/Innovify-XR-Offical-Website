              ...
              <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl space-y-6">
                ...
                <div className="space-y-4 pt-2">
                  <a
                    ...
                    className="p-4 rounded-2xl bg-slate-950 border border-slate-800 hover:border-blue-500/50 transition-all flex items-center justify-between group"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-slate-400">info.innovifyxr@gmail.com</div>
                      </div>
                    </div>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-2">
                    ...
                    <p className="text-[11px] text-slate-400 leading-relaxed">
                      We review every project request and respond with initial feedback or scheduling options within 24 business hours.
                    </p>
                  </div>
                </div>
              </div>
